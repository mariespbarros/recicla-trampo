...
fun NovasColetasScreen(
    ...
    NovasColetasContent(
        ...
        onHistoricoClick = onNavigateToHistoricoCatador
    )
}
    ...
    Scaffold(
        ...
        bottomBar = {
            BottomBar(
                ...
                onCriarClick = { /* Ação para Criar se necessário */ }
            )
        },
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(
                    text = coleta.endereco.ifBlank { "Endereço não informado" },
                    color = Color.Gray,
                    fontSize = 14.sp
                )
            }
